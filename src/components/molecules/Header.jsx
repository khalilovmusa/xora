...
const Header = () => {
  ...
  return (
    <header className='fixed top-0 left-0 z-50 w-full py-10'>
      ...
      <button onClick={() => setIsOpen((prevState) => setIsOpen(!prevState))} className="lg:hidden z-2 size-10 border-2 border-s4/25 rounded-full flex justify-center items-center">
